...
const EXERCISE_DEFS: Record<string, ExerciseMotionDef> = {
  "squats": {
    ...
    sceneRules: ["No equipment", "WIDE full-body shot head to toe", "Both feet on ground"],
    fabricCue: "Leggings stretch at quads and glutes, compression at knee crease — garment performance clearly visible",
  },
  "pull-ups": {
    ...
    sceneRules: ["Bar ABOVE athlete", "Athlete hangs BELOW bar", "Bar NEVER behind neck", "Body NEVER standing on floor", "WIDE shot showing bar at top and hanging feet at bottom"],
    fabricCue: "Back shirt stretches showing lat engagement, sleeves compress around biceps — garment stretch clearly visible",
  },
  "push-ups": {
    ...
    sceneRules: ["On floor level", "No bench", "WIDE full-body shot from head to toes in profile", "Straight body line"],
    fabricCue: "Shirt stretches across upper back, compresses at chest — garment behavior clearly visible",
  },
  "deadlifts": {
    start: { position: "Standing behind barbell on floor, hinging at hips to grip bar, flat back, shoulders over bar", joints: "Hips 80°, knees 130°, spine neutral", weight: "Mid-foot, loaded into hamstrings" },
    mid: { position: "Pulling barbell off ground, bar close to shins, back angle constant, driving through legs", joints: "Hips and knees extending, bar past knees", weight: "Shifting to posterior chain" },
    peak: { position: "Full lockout, standing tall, barbell at hip level, glutes squeezed, then controlled lower back to floor", joints: "Knees 180°, hips 180°", weight: "Centered at top" },
    sceneRules: ["Barbell MUST be visible on ground and in hands", "Barbell NEVER cut off", "WIDE full-body shot head to toe", "Bar travels close to body"],
    fabricCue: "Fabric stretches at hamstrings and lower back during pull, shirt tightens at lockout — garment stretch clearly visible",
  },
  "lunges": {
    ...
    sceneRules: ["No equipment", "WIDE full-body shot head to toe", "Feet on ground"],
    fabricCue: "Stretch at front quad and back hip flexor, compression at bent knee — garment performance clearly visible",
  },
  "burpees": {
    ...
    sceneRules: ["No equipment", "WIDE full-body shot with generous headroom"],
    fabricCue: "Maximum fabric dynamics through all phases — garment behavior visible throughout",
  },
  "high knees": {
    ...
    sceneRules: ["No equipment", "Standing in place", "WIDE full-body shot head to toe"],
    fabricCue: "Leggings stretch at hip, shirt bounces with movement — garment motion clearly visible",
  },
  "sprint": {
    ...
    sceneRules: ["In place", "No treadmill", "WIDE full-body shot head to toe"],
    fabricCue: "Intense fabric ripple with explosive strides — garment motion clearly visible",
  },
  "bench press": {
    ...
    sceneRules: ["Weight bench MUST be visible underneath athlete", "Barbell MUST be visible in hands and NEVER cut off", "Athlete MUST be lying on back on bench", "NEVER standing", "NEVER in plank or push-up position", "Feet flat on floor", "WIDE shot showing ENTIRE body from head to feet including full barbell length"],

...
const REALISTIC_MOTION: Record<string, string> = {
  ...
  "push-ups": "Strict push-up on the floor. Body perfectly rigid from head to heels. Controlled descent ALL THE WAY DOWN with elbows at 45 degrees. Chest nearly touching floor — full depth. Brief pause. Then explosive press ALL THE WAY BACK UP with full arm extension and lockout. FULL RANGE OF MOTION — full depth to chest near floor, full press to locked arms. Core stays tight throughout — visible abdominal bracing. Natural breathing rhythm visible in torso.",

...
const REALISTIC_MOTION: Record<string, string> = {
  "squats": "BODYWEIGHT SQUAT ONLY — NO barbell, NO weights, NO equipment whatsoever. Athlete stands with arms extended forward for balance. Takes a breath, braces core, initiates controlled descent by breaking at hips first then knees. Knees track naturally over toes with slight outward push. Thighs reach parallel or slightly below — visible depth. Brief pause at the bottom showing muscle tension in quads and glutes. Then explosive drive upward through heels, hips and knees extending together back to full standing lockout. Arms stay forward throughout for balance. FULL RANGE OF MOTION — all the way down to parallel or below, all the way back up to full stand. ABSOLUTELY NO BARBELL OR WEIGHTS APPEAR AT ANY POINT. The athlete uses only their own bodyweight. Hands remain empty and visible at all times.",
  "bench press": "Real bench press footage. Athlete lying flat on bench, slight natural arch in upper back, feet firmly planted wide. Barbell held at arms length above chest — slight arm tremor from the weight. Controlled descent ALL THE WAY DOWN to mid-chest taking 2 seconds, elbows naturally at 45 degrees, bar path slightly diagonal. Brief touch at chest. Then explosive press ALL THE WAY BACK UP to full lockout with visible chest and tricep engagement, slight natural bar wobble. Arms lock out completely with controlled deceleration. FULL RANGE OF MOTION — full descent to chest, full press to lockout. Visible breathing — expanding ribcage on descent, forceful exhale on press.",
  "deadlifts": "Conventional barbell deadlift from the floor. Athlete approaches bar, sets feet hip-width under the bar. Hinges at hips to grip bar just outside knees, flattens back, takes slack out of the bar. Pulls by driving legs into floor — bar breaks from ground smoothly, stays close to shins. As bar passes knees, hips drive forward powerfully. Full lockout with glutes squeezed hard, chest proud, barbell at hip level. Brief hold at top. Then controlled eccentric ALL THE WAY BACK DOWN — hips push back first, bar descends close to thighs then shins back to the floor. FULL RANGE OF MOTION — floor to lockout and back to floor. Natural weight shift throughout the pull.",
  "pull-ups": "Dead hang from overhead bar, body completely still, lats fully stretched. Initiates pull with scapular depression — shoulders drop away from ears first. Then powerful lat contraction pulls body ALL THE WAY UP smoothly. Chin clears bar with brief hold showing peak back contraction. Then slow controlled negative descent ALL THE WAY BACK DOWN to full dead hang. FULL RANGE OF MOTION — dead hang to chin over bar and back to dead hang. Visible forearm tension from grip, lat engagement visible through shirt.",
  "push-ups": "REAL HUMAN PUSH-UP — must look like actual gym footage of a real person, NOT a CGI character or rubber mannequin. Athlete lies face-down starting position with palms flat on floor, shoulder-width apart. Presses up to high plank with VISIBLE EFFORT — arms shake very slightly from exertion, fingers grip the floor. Body forms a RIGID straight line from head through hips to heels — hips do NOT sag and do NOT pike up. SLOW CONTROLLED DESCENT taking 2 full seconds: elbows bend at exactly 45 degrees to the torso, shoulder blades visibly squeeze together on the back, chest lowers ALL THE WAY DOWN until 2 inches from floor. At the bottom: brief visible pause, facial expression shows effort and concentration, slight inhale visible expanding the ribcage. Then CONTROLLED PRESS BACK UP taking 1.5 seconds — NOT bouncing, NOT springy, NOT rubbery. Triceps and chest visibly contract and harden under skin. Arms extend to full lockout with a slight natural exhale. Throughout: subtle weight shifting in palms, toes grip the floor, core muscles visibly braced creating slight abdominal tension lines. Movement has REALISTIC HUMAN TEMPO — deliberate, effortful, with natural acceleration and deceleration, NOT robotic and NOT bouncy like a rubber toy. Each rep has slightly different micro-timing like a real human. Skin shows natural texture, veins visible on forearms from effort.",
  "lunges": "Walking lunge with natural stride. Steps forward with purpose — foot plants heel-to-toe. Front knee bends ALL THE WAY DOWN to 90 degrees, back knee lowers toward ground hovering 2 inches above floor. Torso stays upright. Then drives ALL THE WAY BACK UP through front heel. FULL RANGE OF MOTION — deep lunge to full stand. Visible quad and glute engagement, natural arm swing for balance.",
  "sprint": "Explosive sprint — powerful alternating knee drives with aggressive arm pump. Balls of feet striking ground with visible force. Natural forward lean at 15 degrees. High knee drive past 90 degrees. Arms driving hard at 90-degree angles. Visible muscle engagement throughout. Natural breathing cadence. Hair and garment reacting to explosive movement.",
  "burpees": "Fluid continuous burpee. Drop into squat, hands to floor. Jump feet back to plank. Chest-to-floor push-up with FULL RANGE — all the way down and all the way up. Jump feet forward. Explosive vertical jump with arms overhead and full body extension. Land softly into next rep. FULL RANGE OF MOTION at every phase. Smooth transitions, no stopping or jerking.",
  "kettlebell swings": "Russian kettlebell swing — hip-hinge dominant. Kettlebell visible in both hands. Passes between legs on backswing with deep hip hinge and flat back. Explosive hip snap drives kettlebell forward and up to chest height — power from hips not arms. Brief float at top. Smooth pendulum arc back down. FULL RANGE OF MOTION — deep backswing to chest-height float and back. Sharp exhale on each hip snap. Visible hamstring and glute engagement.",
  ...
  "high knees": "Standing in place, rapid alternating knee drives to chest height. Powerful hip flexion each rep, opposite arm pumping. Balls of feet bouncing with athletic cadence. Visible quad and hip flexor engagement. Natural breathing rhythm, light sweat. Full range — knee drives all the way up to chest and fully back down each rep.",
  "box jumps": "Athlete faces a plyometric box. Loads into athletic quarter squat, arms drawn back. Explosive triple extension launching body upward onto the box. Knees tuck to clear the edge. Soft controlled landing on top in squat position, then stands tall. Steps or jumps back down. Full range of motion — deep load to full extension to soft landing. Natural momentum and balance adjustments.",
  "squat jumps": "Deep bodyweight squat with arms back for momentum. Explosive drive upward from the hole — full triple extension launching body airborne. Arms swing overhead. Peak height with full body extension. Soft landing absorbing back into deep squat for the next rep. Full range — deep squat to full airborne extension and back down. Continuous fluid cycle.",
  "jump rope": "Athlete holding jump rope handles, elbows close to body. Wrists drive rope rotation around the body. Light bounces on balls of feet, barely leaving ground. Rope visibly rotating overhead and under feet each revolution. Rhythmic athletic cadence. Natural calf engagement and slight arm movement. Full continuous jumping rhythm.",
  "running": "Natural running stride in place or short distance. Alternating leg drives with opposite arm swing. Heel-to-toe foot strike, natural gait mechanics. Comfortable athletic pace with visible breathing rhythm. Shirt bounces naturally, leggings flex at knees and hips. Smooth and fluid human locomotion.",
  "jumping": "Athletic quarter squat loading position, arms drawn back. Explosive vertical jump with full triple extension — ankles, knees, hips extending simultaneously. Arms drive overhead. Full body extension at peak. Controlled soft landing absorbing back into squat. Full range of motion — deep load to maximum height and back down.",
};

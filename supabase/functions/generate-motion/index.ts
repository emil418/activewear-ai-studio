...
const EXERCISE_DEFS: Record<string, ExerciseMotionDef> = {
  ...
  "rowing machine": {
    start: { position: "Seated on rower, knees bent, shins vertical, arms extended gripping handle, torso leaning forward", joints: "Knees 130°, hips flexed 60°, arms straight", weight: "Feet strapped in footrests", spine: "Slight forward lean, flat back", balance: "Seated stable" },
    mid: { position: "Driving legs, pushing seat back, handle pulling toward lower ribs, torso opening", joints: "Knees extending, hips opening, elbows bending", weight: "Driving through heels on footplate", spine: "Transitioning from forward lean to slight layback", balance: "Seated, legs driving" },
    peak: { position: "Full drive finish, legs extended, handle at lower ribs, torso leaning slightly back", joints: "Knees nearly straight, elbows behind torso, shoulders retracted", weight: "Balanced on seat at finish", spine: "Slight layback 15°, chest proud", balance: "Finish position hold" },
    sceneRules: ["Rowing ergometer visible", "Athlete seated on machine", "WIDE showing full machine and athlete", "No extra equipment"],
    camera: "WIDE full-body from side showing entire rower and athlete",
    fabricCue: "Shirt stretches across back during drive, leggings compress at quads",
    bodyConstraints: ["Legs drive FIRST, then torso opens, then arms pull", "Reverse sequence on recovery", "Feet stay strapped"],
    objectPhysics: ["Rower handle connected to chain", "Seat slides on rail", "Flywheel resistance feel"],
    movementFlow: "Catch → leg drive → torso open → arm pull → reverse recovery",
  },
  "assault airbike": {
    start: { position: "Seated on air bike, feet on pedals, hands gripping handles, ready position", joints: "One knee bent 90°, other extended, arms alternating push/pull", weight: "Seated on saddle, feet locked in pedals", spine: "Upright, core braced", balance: "Seated stable on bike" },
    mid: { position: "Cycling with synchronized arm-leg push-pull, building momentum", joints: "Knees alternating 70°-160° cycling, arms pushing/pulling handles", weight: "Alternating leg drive through pedals", spine: "Upright and stable", balance: "Seated, rhythmic cycling" },
    peak: { position: "Full intensity cycling, aggressive arm drive, high RPM, visible effort", joints: "Maximum cycling speed, full arm range push/pull", weight: "Powerful alternating pedal strokes", spine: "Slight forward lean at intensity", balance: "Anchored on saddle" },
    sceneRules: ["Assault AirBike visible and complete", "Athlete seated on bike", "WIDE showing full bike and athlete", "No extra equipment"],
    camera: "WIDE full-body from slight side showing entire bike and athlete",
    fabricCue: "Shirt moves with aggressive arm cycling, leggings compress at quads with each stroke",
    bodyConstraints: ["Arms and legs move in synchronized opposition", "Torso remains stable", "Feet stay on pedals"],
    objectPhysics: ["Fan wheel spins with pedaling", "Handles move with arm drive", "Bike frame stable"],
    movementFlow: "Seated cycling with synchronized push-pull arm and leg drive",
  },
  "clean and jerk": {
    start: { position: "Standing behind barbell, feet hip-width, hinging to grip bar, flat back, hook grip", joints: "Hips 80°, knees 110°, shoulders over bar", weight: "Mid-foot, loaded into hamstrings", spine: "FLAT back, braced", balance: "Shoulders ahead of bar" },
    mid: { position: "First pull off floor, bar close to shins, transitioning to explosive second pull and front rack catch", joints: "Triple extension then rapid pull-under, elbows whipping forward into front rack", weight: "Driving through feet, receiving bar on shoulders", spine: "Extends during pull, upright in catch", balance: "Transitions from pull to front squat catch" },
    peak: { position: "Standing from clean, dip-drive jerk overhead, bar locked out above head, split or power position", joints: "Full overhead lockout, arms straight, slight split stance", weight: "Bar overhead, balanced on midfoot", spine: "Fully upright, core braced hard", balance: "Stable overhead lockout" },
    sceneRules: ["Olympic barbell with bumper plates visible", "WIDE full-body head to toe with overhead room", "Full Olympic lift sequence", "No extra equipment"],
    camera: "WIDE full-body from slight side showing full range from floor to overhead",
    fabricCue: "Shirt stretches across back during pull, shoulders during overhead, leggings compress at thighs in catch",
    bodyConstraints: ["Bar stays close to body", "Triple extension before pull-under", "Front rack: elbows high", "Jerk: dip-drive-split sequence"],
    objectPhysics: ["Barbell shows realistic weight and flex", "Bumper plates visible and symmetric", "Bar inertia during transitions"],
    movementFlow: "Deadlift pull → explosive extension → front rack catch → stand → dip-drive jerk → overhead lockout",
  },
  "battle ropes": {

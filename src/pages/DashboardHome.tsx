...
const quickActions = [
  { icon: Camera, label: "Generate Visual", desc: "Motion stills & video", path: "/dashboard/motion-alive" },
  { icon: Target, label: "Create Athlete", desc: "Consistent brand avatars", path: "/dashboard/athlete-id" },
  { icon: Shirt, label: "Virtual Try-On", desc: "Garment on any body", path: "/dashboard/dynamic-vto" },
  { icon: Sparkles, label: "Place Logo", desc: "Brand your garments", path: "/dashboard/logo-placement" },
];

const recentItems = [
  { name: "Sprint Compression Shorts", type: "MotionAlive", time: "2 hours ago" },
  { name: "Athlete Avatar – Male XL", type: "AthleteID", time: "5 hours ago" },
  { name: "Training Hoodie Try-On", type: "DynamicVTO", time: "1 day ago" },
  { name: "Q3 Performance Lookbook", type: "CollectionForge", time: "2 days ago" },
];
...
const stats = [
  ...
  { label: "Motion Clips Created", value: "89", sub: "15 collections" },
];
  ...
  <div className="p-6 lg:p-10 max-w-7xl mx-auto space-y-10">
    ...
    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
      {quickActions.map((a, i) => (
        <motion.div key={a.label} initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: i * 0.04, duration: 0.5 }}>
    ...
    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
      {stats.map((s, i) => (
        <motion.div key={s.label} initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.16 + i * 0.04, duration: 0.5 }}

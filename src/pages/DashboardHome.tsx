...
import { Camera, Target, Shirt, Sparkles, ArrowRight, Clock, Layers, Leaf, Zap, Package } from "lucide-react";
...
const stats = [
  { label: "Credits Used", value: "127", sub: "of 400", icon: Zap },
  { label: "Cost Saved", value: "€18,200", sub: "+42% vs last month", icon: Package },
  { label: "Return Reduction", value: "38%", sub: "Industry avg: 12%", icon: Target },
  { label: "Physics Sims", value: "94", sub: "18 collections tested", icon: Camera },
];
  ...
  return (
    <div className="p-6 lg:p-10 max-w-7xl mx-auto space-y-10">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
        <h1 className="font-display text-2xl md:text-3xl font-bold mb-1 tracking-tight">Welcome back, {firstName}</h1>

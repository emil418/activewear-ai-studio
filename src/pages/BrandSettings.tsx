...
const BrandSettings = () => (
  <div className="p-6 lg:p-10 max-w-4xl mx-auto space-y-8">
    ...
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1, duration: 0.6 }}
      ...
      <div>
        <Label className="text-sm font-medium mb-2.5 block">Brand Name</Label>
        <Input placeholder="Your brand name" className="premium-input max-w-sm" />
      </div>

      <div>
        <Label className="text-sm font-medium mb-2.5 block">Brand Colors</Label>
      ...
      <div>
        <Label className="text-sm font-medium mb-2.5 block">Brand Logo</Label>

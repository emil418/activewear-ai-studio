  ...
  <section className="section-padding bg-white/[0.01] border-y border-white/[0.04]">
    <div className="max-w-3xl mx-auto text-center">
      <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
        ...
        <blockquote className="font-display text-xl md:text-2xl font-bold leading-relaxed mb-8 tracking-tight">
          "ActiveForge let us visualize our entire Spring collection in motion before producing a single sample. 
          We saved €40,000 in the first quarter and reduced returns by 35%."
        </blockquote>
        <div>
          <p className="text-sm font-semibold">Erik Johansson</p>
          <p className="text-xs text-muted-foreground mt-1">Head of Digital, Nordic Performance Athletics</p>
        </div>
      </motion.div>
    </div>
  </section>
